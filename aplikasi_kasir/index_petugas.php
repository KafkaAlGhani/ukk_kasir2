...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-warning bg-warning">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index_petugas.php">Aplikasi Kasir</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <a class="dropdown-item" href="?page=profile_petugas">Profile</a>
        </ul>
        </li>
        </ul>
    </nav>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark bg-secondary" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="?page=pembelian_petugas">
    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home_petugas';
            include $page . '.php';
