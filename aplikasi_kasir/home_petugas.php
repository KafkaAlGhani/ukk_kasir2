    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card bg-primary text-white shadow-sm">
                <div class="card-body">
                    <h5 class="card-title">
                        <?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pelanggan")); ?></h5>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card bg-warning text-white shadow-sm">
                <div class="card-body">
                    <h5 class="card-title">
                        <?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM produk")); ?></h5>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card bg-success text-white shadow-sm">
                <div class="card-body">
                    <h5 class="card-title">
                        <?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM penjualan")); ?></h5>
